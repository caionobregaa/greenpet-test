...
export class PrismaProdutoRepository implements IProdutoRepository {
  ...
  async save(produto: Produto): Promise<void> {
    const data = {
      ...
      faseDaVida: produto.faseDaVida ?? null,
      porte: produto.porte ?? null,
      sabor: produto.sabor ?? null,
  ...
  private toDomain(row: Record<string, unknown>): Produto {
    return Produto.create({
      ...
      faseDaVida: (row.faseDaVida as string | null) ?? undefined,
      porte: (row.porte as string | null) ?? undefined,
      sabor: (row.sabor as string | null) ?? undefined,
      marca: (row.marca as string | null) ?? undefined,
      fornecedor: (row.fornecedor as string | null) ?? undefined,
      codigoBarras: (row.codigoBarras as string | null) ?? undefined,
      semCodigoBarras: (row.semCodigoBarras as boolean | null) ?? false,
      ...
      estoqueMinimo: (row.estoqueMinimo as number | null) ?? undefined,
