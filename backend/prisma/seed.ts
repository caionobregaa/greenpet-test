...
const PRODUTOS_ZOO_CENTER: ProdutoSeed[] = [
  ...
  { nome: 'FN Life Adulto Porte Médio/Grande 15kg',          categoria: 'Ração', especie: 'Cão', subCategoria: 'Life Adulto',      marca: 'Fórmula Natural', fornecedor: 'Zoo Center', pesoEmbalagem: 15,   valorCusto: 180.09, valorVenda: 295,    ...M_ZOO_CENTER },
